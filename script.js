                        ...
                        if (R.identifier) {
                            if (R.type) {
                                ...
                                if (Type == 'crafting_shaped') {
                                    var BackgroundImage = '<img src="./Minecraft-Recipe-Display/theme/' + theme + '/mc_crafting_shaped.png" alt=" " draggable="false">'
                                } else if (Type == 'crafting_shapeless') {
                                    var BackgroundImage = '<img src="./Minecraft-Recipe-Display/theme/' + theme + '/mc_crafting_shapeless.png" alt=" " draggable="false">'
                                } else if (Type == 'smelting') {
                                    var BackgroundImage = '<img src="./Minecraft-Recipe-Display/theme/' + theme + '/mc_smelting.gif" alt=" " draggable="false">'
                                } else if (Type == 'stonecutter') {
                                    var BackgroundImage = '<img src="./Minecraft-Recipe-Display/theme/' + theme + '/mc_stonecutter.png" alt=" " draggable="false">'
                                } else if (Type == 'smithing') {
                                    var BackgroundImage = '<img src="./Minecraft-Recipe-Display/theme/' + theme + '/mc_smithing.png" alt=" " draggable="false">'
                                };
